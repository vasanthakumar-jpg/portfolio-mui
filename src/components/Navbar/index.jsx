...
//                 <ListItemText
//                   primary={item.label}
//                   sx={{ color: mode === "dark" ? "#ffffff" : "#1E293B", fontFamily: `'Poppins', 'Inter', sans-serif` }}
//                 />
//               </ListItemButton>
//             </ListItem>
//           </motion.div>
...
//         <Typography
//           variant="body2"
//           sx={{ ml: 1, color: mode === "dark" ? "#ffffff" : "#1E293B", fontFamily: `'Poppins', 'Inter', sans-serif` }}
//         >
...
//               >
//                 <MenuIcon sx={{ color: mode === "dark" ? "#ffffff" : "#1E293B" }} />
//               </IconButton>
//             )}
//           </Toolbar>
//         </AppBar>
